#!/usr/bin/env swift
//
//  chromaforge-cli.swift
//  ChromaForge
//
//  Created by Michael Stebel on 5/19/26.
//  Updated by Michael on 5/28/26.
//
...
func printUsage(to stream: UnsafeMutablePointer<FILE> = stdout) {
    fputs(
        ...
        Usage:
          swift Tools/chromaforge-cli.swift audit <file> [--gate aa|aaa|large] [--json]
          swift Tools/chromaforge-cli.swift extract <file> [--json]
...
func runExtract(filePath: String, json: Bool) throws -> Int32 {
    ...
    if json {
        ...
        print("ChromaForge extract: \(fileURL.lastPathComponent)")
...
func runAudit(filePath: String, gate: ContrastGate, json: Bool) throws -> Int32 {
    ...
    if json {
        ...
        print("ChromaForge audit: \(fileURL.lastPathComponent)")
